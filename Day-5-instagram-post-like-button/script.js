...
like.addEventListener("click", () => {
    like.classList.replace('ri-heart-line', 'ri-heart-fill');
...
like.addEventListener('dblclick', () => {
    like.classList.replace('ri-heart-fill', 'ri-heart-line');
...
bkm.addEventListener('click', () => {
    bkm.classList.replace('ri-bookmark-line', 'ri-bookmark-fill');
});
